...
is issued as BRIEF_020 with G1 (the complex-rate Γ integral) inside it as the
identification's engine; both stay open until implemented. **BRIEF_017 is issued**
...
`ε ↓ 0` half (2b) is queued behind it. Item 6's expectation-level twin stays
gated until 2b. The requirement it is
