...
| 4 | *(docs)* | this row's documentation commit (row verdict, CI history, C16, the `docs/03` §D1 item-7 status, the `docs/04` queue row, the brief's LANDED status, README) re-grades on the docs-only diff. | see PR #19 checks |
