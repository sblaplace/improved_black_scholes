...
| 8 | BRIEF_008 (T6 sub-goal 3b: Fourier inversion and real-valuedness) | arena-ai-coding-agent | [#10](https://github.com/sblaplace/improved_black_scholes/pull/10) | **PENDING** — new module `ImprovedBS/Inversion.lean` (13 declarations), statement pins 81 → 94, oracle Carr–Madan Fourier inversion route (`bs_call_by_fourier_inversion` ≤ 2.02e-11 rel on 39-point grid, complex imaginary part ≤ 1e-13) + mutant M12, CI-only two-run pin bootstrap. |
